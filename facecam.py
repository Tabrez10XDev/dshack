...
os.chdir(r'C:\Users\meett\OneDrive\Desktop\dshack')
import nest_asyncio
...
class Facecamera(object):
    ...
    # loading list
    with open('C:/Users/meett/PycharmProjects/dshack0.1/encod_list.data', 'rb') as filehandle:
        # read the data as binary data stream
        known_face_encodings = pickle.load(filehandle)
    with open('C:/Users/meett/PycharmProjects/dshack0.1/face_list.data', 'rb') as filehandle1:
        # read the data as binary data stream
